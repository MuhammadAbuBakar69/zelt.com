const hamburger = document.querySelector('.hamburger');
        ...
        document.addEventListener('DOMContentLoaded', function() {
          // Create and load the Spline iframe
          const splineContainer = document.getElementById('spline-viewer');
          const iframe = document.createElement('iframe');
          iframe.src = 'https://prod.spline.design/TW2VAC1xkZDi4Pdc/scene.splinecode?embed=true';
          
          // Add load event listener
          iframe.addEventListener('load', function() {
              // Ensure iframe is non-interactive
          ...
          window.addEventListener('resize', function() {
              // You can add additional resize handling if needed
